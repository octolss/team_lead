...
public:
    // Method to add a user to the bannedUsers vector
...
public:
    ...
    void displayInfo() override {
        cout << "Jeans - Brand: " << brand << ", Type: " << type << ", Amount: " << amount << ", Gender: " << gender << ", Size: " << size << ", Material: " << material << ", Color: " << color << endl;
    }
};
...
int main() {
    ...
    // Example usage of banning a user
    Admin admin;
    User user1;
